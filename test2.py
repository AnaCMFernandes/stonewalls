...
os.remove(csv_out)
# create new CSV file containing X (distance) and Z
value pairs
...
line = LineString([(-13659328.8483806, 6450545.73152317),
(-13651422.7820022, 6466228.25663444)])
...
z.append(get_elevation(xp, yp, ds, bands,
transform)[0])
